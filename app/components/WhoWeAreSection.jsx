...
const WhoWeAreSection = () => {
  return (
    <div className="lg:px-36 mx-auto">
      ...
      <div className="text-gray-800 text-lg lg:text-[20px]  leading-[30px] lg:w-[1100px] font-light ">
        <p>
          ...
          success. <br /> St. Xavier's Junior College offers cutting edge training with
