...
const StatsDashboard = () => {
  return (
    <div
      className="p-4 md:p-8 rounded-lg md:px-40 mt-8 md:mt-24 pb-8 md:pb-16"
    ...
    >
      ...
      {/* Academic Awards Row */}
      <div className="flex flex-col md:flex-row justify-between pb-6 mb-6 border-b">
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-1/2 mb-4 md:mb-0">
